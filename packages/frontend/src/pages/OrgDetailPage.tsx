  ...
  return (
    <div className='space-y-6'>
      ...
      <section>
        ...
        {membersLoading ? (
          <div className='rounded-xl border border-line bg-ink/[0.02] p-4 animate-pulse'>
        ...
        {packagesLoading ? (
          ...
          <ul className='space-y-2'>
            {packages.map(pkg => {
              ...
              return (
                <li key={pkg}>
                  <div className='flex items-center gap-3 rounded-xl border border-line bg-ink/[0.02] px-4 py-2.5 group hover:border-line hover:bg-ink/[0.04] transition-colors'>
                    <Link
      ...
      {(hasOrgInfo || isAdmin) && (
        <section>
          ...
          {isEditingSettings ? (
            <div className='rounded-xl border border-line bg-ink/[0.02] p-4 space-y-3'>
              <SettingsField
                label='Display name'
