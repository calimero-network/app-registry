        ...
        <div className='card p-6'>
          ...
          <form onSubmit={handleCreateOrg} className='space-y-3'>
            ...
            <button
              ...
              className='rounded-lg bg-brand-accent hover:bg-brand-accent-hover disabled:opacity-50 disabled:cursor-not-allowed text-black px-4 py-2 text-sm font-medium transition-colors'
            >
