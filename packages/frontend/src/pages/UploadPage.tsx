        ...
        <div className='mt-3 space-y-2'>
          ...
          <div className='grid grid-cols-[auto_1fr] gap-x-3 gap-y-2.5 text-[12px]'>
            ...
            <div>
              ...
              <pre className='bg-neutral-950 border border-line rounded-md px-3 py-2 text-[12px] text-neutral-300 font-mono overflow-x-auto leading-relaxed'>
...
function Pre({ children }: { children: string }) {
  return (
    <pre className='bg-neutral-950 border border-line rounded-md p-3.5 text-[12px] text-neutral-300 font-mono overflow-x-auto leading-relaxed'>
      {children}
    </pre>
  );
}
...
function ScriptBlock({
  ...
  return (
    <div className='bg-ink/[0.02] border border-line rounded-md p-3.5'>
...
function DocLink({ href, label }: { href: string; label: string }) {
  return (
    <a
      ...
      className='inline-flex items-center gap-1.5 text-[12px] text-neutral-400 hover:text-neutral-200 bg-ink/[0.04] hover:bg-ink/[0.08] border border-line px-2.5 py-1.5 rounded-md transition-all'
    >
