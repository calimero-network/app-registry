...
export function AppIcon({
  ...
  if (icon && !failed) {
    return (
      <img
        ...
        className={cn(
          rounded,
          'flex-shrink-0 object-cover bg-white/[0.04] border border-white/[0.08]',
          className
        )}
  ...
  return (
    <div
      ...
      className={cn(
        rounded,
        'flex-shrink-0 grid place-items-center border border-white/[0.08] font-semibold text-white/80 select-none',
        className
      )}
      style={{
        width: size,
