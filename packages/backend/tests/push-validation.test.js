  ...
  describe('Request Body Validation', () => {
    ...
    test('should accept valid object body', async () => {
      req.body = {
        ...
        metadata: {
          name: 'Test App',
          // Complete on purpose: this test is about body handling, but a new
          // package must satisfy the metadata policy to reach 201 at all.
          description: 'A test app used to exercise push body validation.',
          author: 'Test Author',
